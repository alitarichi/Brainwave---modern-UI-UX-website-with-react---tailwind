...
const Headrer = () => {
  return (
    ...
    >
      <div
        className="flex item-center px-5 lg:px-7.5
      xl:px-10 max-lg:py-4"
      ></div>
      <a className="block w-[12rem] xl:mr-8" href="#hero">
        <img src={brainwave} width={190} height={60} alt="Brainwave" />
      </a>

      <nav
        className="hidden fixed top-[5rem] left-0
      right-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent"
      >
        <div
